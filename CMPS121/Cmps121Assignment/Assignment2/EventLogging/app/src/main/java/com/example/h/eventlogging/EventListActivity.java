        ...
        try{
            ...
            list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    detailIntent.putExtra("time", selected.timeText);
                    detailIntent.putExtra("date", selected.dateText);
                    detailIntent.putExtra("gps", selected.gpsText);
                    detailIntent.putExtra("event", selected.eventText);
                    detailIntent.putExtra("pos", position);
//                    detailIntent.putExtra("aList", aList);
//                    detailIntent.putExtra("jos", jos.toString());
/*
                    Log.d("josToString", jos.toString());
                    Log.d("aList in Event", aList.toString());
*/
