/* Example showing the use of an audio recorder.
Example taken from https://www.tutorialspoint.com/android/android_audio_capture.htm
 */

package com.example.dustinadams.audiorecord;
...
public class MainActivity extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // disable all buttons except record so they can't be pressed
