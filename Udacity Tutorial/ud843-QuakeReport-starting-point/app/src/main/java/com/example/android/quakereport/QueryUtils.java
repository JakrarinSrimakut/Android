...
public final class QueryUtils {
    ...
    private static ArrayList<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            JSONArray earthquakesArray = root.optJSONArray("features");
            ...
            for(int i=0; i<earthquakesArray.length();i++){
                ...
                JSONObject earthquakeObjectProperties = earthquakeObject.getJSONObject("properties");

                // Extract the value for the key called "url"
                String url = earthquakeObjectProperties.getString("url");

                //Extract “mag” for magnitude
                double mag = earthquakeObjectProperties.getDouble("mag");

                //Extract “place” for location
                String place = earthquakeObjectProperties.getString("place");

                //Extract “time” for time
                long time= earthquakeObjectProperties.getLong("time");
